...
class FaceRecognizer:
    ...
    def __init__(self, model_dir, tpu=True, mask=False):
        ...
        try:
            ...
            self.interpreter = tf.compat.v1.lite.Interpreter(model_path="Mobilefacenet/pretrained_model/training_model/inference_model_993_quant.tflite")
        self.interpreter.allocate_tensors()
        ...
        if self.mask:
            ...
            self.mask_output_index = self.interpreter.get_output_details()[1]['index']
            #print('here')
        else:
            #print(self.interpreter.get_output_details())
            self.rec_output_index = self.interpreter.get_output_details()[0]['index']
